...
public class Home extends JFrame implements ActionListener{
    ...
    public Home(){
        setBounds(200,2,1000,800);
        contentPane = new JPanel();
        setContentPane(contentPane);
        contentPane.setLayout(null);
        
        JMenuBar menuBar = new JMenuBar();
        menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED,new Color(0,120,0),new Color(128,128,128)));
        ...
        miBookDetails.setForeground(Color.DARK_GRAY);
        ...
        miStudentDetails.setForeground(Color.DARK_GRAY);
